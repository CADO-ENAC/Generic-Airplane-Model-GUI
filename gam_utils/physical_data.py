...
class PhysicalData(object):
    ...
    def __init__(self):
        ...
        self.co2_index_data = {"kerosene": 3.14,
                               "petrol": 3.14,
                               "e_fuel": 3.14,
                               "gasoline": 3.14,
                               "liquid_h2": 0.,
    ...
    def co2_index(self, fuel_type):
        """Emission index of CO2 in kg_CO2 / kg_fuel
        """
        ico2 = self.co2_index_data.get(fuel_type, "fuel_type key is unknown")
        return ico2
