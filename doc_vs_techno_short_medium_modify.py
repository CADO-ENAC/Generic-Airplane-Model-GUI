...
from draw_domains import draw_domains
from draw_domains import find_index, draw_domains
import matplotlib.pyplot as plt

def init_short(max_fuel_factor, stdm_factor, lod_factor,
    ...
    # Explore short_medium category
    #-----------------------------------------------------------------------------------------------------------------------
    design_mission = {"category": "short_medium",
                    "npax": 150,
                    "range": unit.convert_from("km", 4500),
                    "speed": 0.78,
                    "altitude": unit.convert_from("ft", 35000)}

    # Short_medium settings
    bpr = 12
    npax_window = [80, 250]
    dist_window = [4500, 8000]
