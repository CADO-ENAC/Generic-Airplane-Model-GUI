...
def init_commuter(max_fuel_factor, stdm_factor, lod_factor,
    ...
    # Explore commuter category
    #-----------------------------------------------------------------------------------------------------------------------
    design_mission = {"category": "commuter",
                    "npax": 19,
                    "range": unit.convert_from("km", 250),
                    "speed": unit.convert_from("km/h", 350),
                    "altitude": unit.convert_from("ft", 10000)}

    # Commuter settings
    npax_window = [2, 19]
    dist_window = [250, 1500]
